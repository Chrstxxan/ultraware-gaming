...
<?php foreach ($products as $p): ?>
    ...
    <a href="/ultraware_gaming/public/product.php?id=<?= $p['id'] ?>" class="block">

        <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 shadow-lg hover:border-primary transition">
            ...
            <div class="flex justify-between items-center mt-4">
                ...
                <div class="bg-primary px-4 py-2 rounded-lg text-white">
                    Ver produto
                </div>
